...
v_dust: 	equ (v_objspace+$1C0)
v_hudring:		equ (v_objspace+$300)
...
v_pal_buffer_end:	equ	v_pal_buffer+$30
...
v_bgswapper_vblank:	equ $FFFFF7A2	; The rendering marker for the gradual background swapper. Set to -16 to render a full 512x256 plane. Used in Vblank
...
v_timefromstart:	equ $FFFFF7DA	; GIO: frame counter from start of level. used by deformation
