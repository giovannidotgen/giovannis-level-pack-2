...
loc_11E40:
		...
		cmp.b	(a1),d1	; GIO: Normally, the orbinaut does not check that what it is deleting is actually an orb. This can have dangerous side effects!
		bne.s	.notSelf				
		bsr.w	DeleteChild
	.notSelf:	
		dbf	d2,loc_11E40
